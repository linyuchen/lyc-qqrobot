...
import 归档.webqq.qqapi
from qqsdk.归档 import events
from qqsdk import message
from status_codes import *
from qqsdk import entity
from response import Response
from 归档.log_helper import GeneralLogger



class QQClient(归档.webqq.qqapi.QQApi, threading.Thread):
    
    def __init__(self, qq, pwd):
        归档.webqq.qqapi.QQApi.__init__(self, qq, pwd)
