<<<<<<< HEAD:qqsdkplugins/待修改/group_note/__init__.py
#coding=UTF8
...
class MyEvent(MsgEvent):
    ...
    def main(self, msg):
        ...
        if self.cmdGetJoinNote.az(msg.msg):
            ...
            if member.isAdmin:
                param = self.cmdSetJoinNote.get_original_param()
        ...
        if self.cmdGetExitNote.az(msg.msg):
            ...
            if member.isAdmin:
                param = self.cmdSetExitNote.get_original_param()
        ...
        if self.cmdGetKickNote.az(msg.msg):
            ...
            if member.isAdmin:
                param = self.cmdSetKickNote.get_original_param()
...
>>>>>>> cd04e7609aa41a427ce4bf4b29e124de6a13fa90:qqsdkplugins/待修改/group_note/__init__.py
