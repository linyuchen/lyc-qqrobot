...
from src.common.utils.downloader import download_with_progressbar
...
if not model_path.exists():
    download_with_progressbar("https://s3.amazonaws.com/ir_public/nsfwjscdn/nsfw_mobilenet2.224x224.h5",
                              model_path)
