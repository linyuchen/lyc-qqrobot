...
class MyEvent(MsgEvent):
    ...
    def main(self,msg):
        ...
        if self.cmdClrScreen.az(msg.msg):
            ...
            if member.isAdmin:
                param = self.cmdKick.getParamList()[0]
                if param.isdigit():
            ...
            if member.isAdmin:
                params = self.cmdAddSensitiveWords.getParamList()
                for word in params:
            ...
            if member.isAdmin:
                params = self.cmdDelSensitiveWords.getParamList()
                for word in params:
            ...
            if member.isAdmin:
                params = self.cmdAddProhibitedWords.getParamList()
                for word in params:
            ...
            if member.isAdmin:
                params = self.cmdDelProhibitedWords.getParamList()
                for word in params:
            ...
            if member.isAdmin:
                param = self.cmdOtherWarningCount.getParamList()[0]
            ...
            if member.isAdmin:
                param = self.cmdClearWarningCount.getParamList()[0]
                warningCount = groupManager.getMemberWarningCount(groupQQ, param)
                #print warningCount
                if warningCount:
            ...
            if member.isAdmin:
                param = self.cmdSetShuabingMaxRows.getParamList()[0]
            ...
            if member.isAdmin:
                param = self.cmdSetShuabingMaxWords.getParamList()[0]
                if not param.isdigit():
            ...
            if member.isAdmin:
                param = self.cmdSetShuabingMaxContinuous.getParamList()[0]
                if not param.isdigit():
        ...
        # 黑名单
            ...
            if member.isAdmin:
                param = self.cmdAddBlackQQ.getParamList()[0]
                if not param.isdigit():
                    result += u"QQ号只能为数字!\n"
                else:
            ...
            if member.isAdmin:
                param = self.cmdDelBlackQQ.getParamList()[0]
                if not param.isdigit():
                    result += u"QQ号只能为数字!\n"
                else:
