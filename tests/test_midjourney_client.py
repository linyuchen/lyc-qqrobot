...
from msgplugins.midjourney.midjourney_client import MJSeleniumClient, TaskCallbackResponse
...
class TestMidjourneyClient(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.client = MJSeleniumClient(url=url, debug_address="127.0.0.1:9990")
